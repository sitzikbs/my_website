...
- 🚀 Fast loading - static HTML generated by Eleventy
- 📝 Easy blog post management via Markdown files
- 📚 Publications page with dynamic loading
- ✍️ Blog with individual post pages (Markdown to HTML)
...
├── index.html              # Homepage (processed by 11ty)
...
│   ├── data-loader.js     # Homepage data loading
