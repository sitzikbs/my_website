...
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/2D_GMM_demonstration.png", "2D Gaussian Mixrure Model example" %}
{% raw %}
...
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/3D_GMM_demonstration.png", "3D GMM example" %}
{% raw %}
