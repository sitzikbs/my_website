...
<p>This group is composed of truly amazing people from all around the world:  from Bosnia (<a href="https://scholar.google.com/citations?user=HHuii4cAAAAJ" rel="noopener" target="_blank">Dejan Azinović</a> working on inverse rendering), Slovenia (<a href="https://scholar.google.com/citations?user=3V8dX-AAAAAJ">Aljaž Božič </a>working on tracking and reconstructing non-rigidly deforming objects in dynamic environments), and China (<a href="https://scholar.google.com/citations?user=LrlcE7kAAAAJ" rel="noopener" target="_blank">Ji Hou</a> working on 3D scene understanding).  From Germany, there is also <a href="https://scholar.google.com/citations?user=6bqVHK0AAAAJ" rel="noopener" target="_blank">Armen Avetisya</a> working on 3D Alignment and Object retrieval between Scan and CAD, but he has the temperament of an Israeli.  Other visitors include <a href="#">Lei Han, </a><a href="#">Xiaochen Fan, </a>and <a href="http://stanford.edu/~jingweih/">Jingwei Huang</a>.</p>
