...
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/IMG_7739.jpg", "" %}
...
<p>Here is the result:</p>
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/IMG_6788.jpg", "" %}
...
{% responsiveImage "../../assets/images/blog/Shaked_Dinosaur_costume_3.jpg", "" %}
...
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/very-hungry-catterpilar-costume.jpg", "" %}
{% raw %}
...
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/knit-lion-costume-2.jpg", "" %}
{% raw %}
...
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/Minion-Costume.jpg", "" %}
{% raw %}
...
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/IMG_20170222_202112.jpg", "" %}
{% raw %}
...
<p style="text-align: center;">{% endraw %}
{% responsiveImage "../../assets/images/blog/triceratops-head.jpg", "" %}
...
<p>{% endraw %}
{% responsiveImage "../../assets/images/blog/IMG_20170227_205523.jpg", "" %}
{% raw %}


</p>
<p>The purple circles and the stripes of the back were sewn like an applique using a zigzag stitch (far from perfect). {% endraw %}
{% responsiveImage "../../assets/images/blog/IMG_20170302_215246.jpg", "" %}
{% raw %}
