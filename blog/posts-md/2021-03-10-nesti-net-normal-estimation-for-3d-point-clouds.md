...
{% responsiveImage "../../assets/images/blog/2019-03-NestiNet_pipeline-01_for_web.jpg", "Nesti-Net normal estimation from unstructured 3D point clouds pipeline" %}
{% raw %}


<figcaption>Nesti-Net normal estimation pipeline</figcaption></figure>{% endraw %}
</div>
